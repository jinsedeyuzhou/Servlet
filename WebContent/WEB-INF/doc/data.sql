...
INSERT INTO news_feed VALUES(null,"�ҳ����ܳ����ͺ���","www.baidu.com","www.baidu.com",null,"0",1,"www.baidu.com");
SELECT * FROM news_feed;

alter TABLE news_feed ADD feed_thumbnail VARCHAR(50) AFTER feed_type;

alter table news_feed comment '�����б�';
...
alter table topics comment '���⣺չʾ��ͬ��������';
